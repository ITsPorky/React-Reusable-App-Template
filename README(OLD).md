...
The Button component will add a styled button component to th site.
...
- `className` = This prop when given a value(s), will add them to the `class=""` attribute of the html element.
- `Style` = This prop when given a value(s), will add them to the `style=""` attribute of the html element.
- `text` = This prop will use the given text as the information text that will be displayed in the popup.
...
The Toast component will add a Toast style popup to appear from the bottom when the item is clicked.

**props**

- `className` = This prop when given a value(s), will add them to the `class=""` attribute of the html element.
- `Style` = This prop when given a value(s), will add them to the `style=""` attribute of the html element.
- `title` = This prop will use the given text as the title that will be displayed in the popup.
- `text` = This prop will use the given text as the information text that will be displayed in the popup.
- `timer` = An integer value that will be used as the countdown for the Toast popup and will determine how long the popup will display for before closing.
...
The Notification component will add a Notification style popup to appear from the top right when the item is clicked.
...
- `title` = This prop will use the given text as the title that will be displayed in the popup.
- `text` = This prop will use the given text as the information text that will be displayed in the popup.
- `timer` = An integer value that will be used as the countdown for the Notification popup and will determine how long the popup will display for before closing.
